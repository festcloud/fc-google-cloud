...
public class StorageClient {
  ...
  public static StorageClient create(String project, @Nullable String serviceAccount,
                                     Boolean isServiceAccountFilePath, @Nullable String readTimeout)
    throws IOException {
  ...
  public static StorageClient create(GCPConnectorConfig config, String readTimeout) throws IOException {
    return create(config.getProject(), config.getServiceAccount(), config.isServiceAccountFilePath(), readTimeout);
  }
